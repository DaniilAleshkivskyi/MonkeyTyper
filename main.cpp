...
#include "src/GameStates/GameState.hpp"
#include "src/IOIteractions/MouseIteraction.hpp"
#include "src/helpers/PlaceChooseMenu.hpp"
#include "src/Game/ConfigMenu/ConfigOption.hpp"
#include "src/Game/ConfigMenu/ConfigClick.hpp"
#include "src/Game/Game.hpp"
#include "src/Game/BestScoresMenu/BestScoresMenu.hpp"
#include "src/Game/GamePlay/GamePlay.hpp"
...
//     BestScoresMenu bsm;
//     bsm.bestScoresSearcher(bestScoresPath,bestScoresList,colorButt,colorTxt,bestScoresShapes,font,window,bestScoresText,bestScoresNum);
//
//
//     /*--------------------------------------------------*END OF BEST SCORES*---------------------------------------------------------------*/
//     /*--------------------------------------------------------*GAMEPLAY*-----------------------------------------------------------------------*/
